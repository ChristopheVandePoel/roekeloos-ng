...
import * as optsParser from 'opts-parser';
...
import * as BrushBase from '../../brush-base/brush-base';
...
const sh = {
  ...
  highlight: function(globalParams, element)
  {
    ...
    for (var i = 0, l = elements.length; i < l; i++)
    {
      ...
      matches = applyRegexList(code, brush.regexList);
 ...
 */
function findBrush(alias, showAlert = false)
{
  ...
  if (brushes == null)
  {
    ...
    //console.log('brush', brushName, sh.brushes[brushName])
      ...
      var brush = sh.brushes[brushName],
        aliases = brush.aliases || brush.getAliases();
        ;
