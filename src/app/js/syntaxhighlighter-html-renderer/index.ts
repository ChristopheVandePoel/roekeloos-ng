...
export default class Renderer{
  ...
  matches: any;
  lines: any;
  linesToHighlight: any;

  constructor(code, matches, opts){
      var _this = this;
   ...
   */
  wrapLinesWithCode(str: any, css: any)
  {
   ...
   * @return {String}       Returns HTML markup.
   */
  renderLineNumbers(code, lineNumbers = null)
  {
    var _this = this,
        opts = _this.opts,
        html = '',
   ...
   */
  getCodeLinesHtml(html, lineNumbers)
  {
  ...
  {
    function getBrushNameCss(match = null)
    {
